...
class YHSlider: UIView {
    ...
    //圆弧滑过的颜色
    var sliderSlipColor = UIColor.mainColor
    //边框宽度
    var sliderBoardWidth: CGFloat = 0
    //边框颜色
    ...
    override func draw(_ rect: CGRect) {
        ...
        ctx.strokePath()
//        if let result = getPointAndRotate(value: value-Double(titles.first!), angle: angle, radius: radius, half: false) {
