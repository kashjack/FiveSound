...
extension Notification.Name {
    public static let kWUTimeCountDown = Notification.Name.init("kWUTimeCountDown")
    
    public static let kMessageCenterReadStatue = Notification.Name.init("kMessageCenterReadStatue")
}
